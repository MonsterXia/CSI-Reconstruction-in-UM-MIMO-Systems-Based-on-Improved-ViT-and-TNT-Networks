...
def main():
    ...
    writer = SummaryWriter("../result/logs/Transformer_ViT")
    output_list = []
    ...
    for envir in Environment:
        ...
        for encoded_dim in Digit:
            ...
            file_path = "../model/Transformer_ViT/Transformer_ViT_{}_{}.pth".format(envir.name, encoded_dim.value)
            if os.path.isfile(file_path):
                print("Model Transformer_ViT_{}_{} exist, try to load model!".format(envir.name, encoded_dim.value))
            ...
            for epoch in range(num_epochs):
                ...
                writer.add_scalar("Transformer_ViT_{}_{}'s value_loss".format(envir.name, encoded_dim.value), test_loss,
                                  epoch)
                writer.add_scalar("Transformer_ViT_{}_{}'s rho".format(envir.name, encoded_dim.value), rho, epoch)
